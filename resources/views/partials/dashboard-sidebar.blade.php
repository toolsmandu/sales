@php
    ...
    $links[] = [
        'route' => 'family-sheet.index',
        'active' => ['family-sheet.index'],
        'label' => 'Family Sheet',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M144 96a80 80 0 1 1 160 0A80 80 0 1 1 144 96zM0 256c0-53 43-96 96-96h160c53 0 96 43 96 96v80c0 8.8-7.2 16-16 16H230.3c-6.6 0-12.5-4.1-14.8-10.3l-15.2-40.6c-1.2-3.1-4.2-5.1-7.5-5.1s-6.3 2.1-7.5 5.1l-15.2 40.6c-2.3 6.2-8.2 10.3-14.8 10.3H16c-8.8 0-16-7.2-16-16V256zM416 96a80 80 0 1 1 160 0A80 80 0 1 1 416 96zM608 240c-11.5 0-22.6 2.3-32.7 6.3c.7 3.8 1.1 7.7 1.1 11.7v80c0 17.7-14.3 32-32 32H416c-17.7 0-32-14.3-32-32V272c0-4 .4-7.9 1.1-11.7c-10.1-4-21.2-6.3-32.7-6.3c-4.3 0-8.5 .4-12.6 1c.4 2.9 .6 5.9 .6 9v80c0 17.7-14.3 32-32 32H260.3c4 9.4 6.3 19.7 6.3 30.5c0 23.2-9.4 44.2-24.6 59.5C245.4 472.6 266.4 480 288 480h16c19.5 0 38.6-5.1 55.4-14.8L400 448l40.6 17.2C457.4 474.9 476.5 480 496 480h16c61.9 0 112-50.1 112-112V288c0-26.5-21.5-48-48-48z"/></svg>',
    ];
    if ($isAdmin) {
        $links[] = [
            'route' => 'reports',
    ...
    if ($isAdmin) {
        $links[] = [
            ...
            'active' => ['orders.logs'],
            'label' => 'Order Changes',
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M160 32c-17.7 0-32 14.3-32 32l0 32-64 0C46.3 96 32 110.3 32 128l0 320c0 17.7 14.3 32 32 32l384 0c17.7 0 32-14.3 32-32l0-320c0-17.7-14.3-32-32-32l-64 0 0-32c0-17.7-14.3-32-32-32l-160 0zm0 64l160 0 0 32-160 0 0-32zM256 256c17.7 0 32 14.3 32 32l0 64 64 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-64 0 0 64c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-64-64 0c-17.7 0-32-14.3-32-32s14.3-32 32-32l64 0 0-64c0-17.7 14.3-32 32-32z"/></svg>',
        ];
    }
