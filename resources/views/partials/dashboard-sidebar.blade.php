@php
    ...
    if ($isAdmin) {
        $links[] = [
            ...
            'active' => ['dashboard.settings.index'],
            'label' => 'Settings',
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M487.4 315.7c3.8-20.9 3.8-42.5 0-63.4l48.6-37.9c4.6-3.6 5.8-10.1 2.8-15.2l-46-79.7c-3-5.1-9.3-7.4-14.9-5.5l-57.2 19.9c-16.5-13.5-35.4-24-55.5-30.9l-12.5-59.2c-1.2-5.6-6.1-9.6-11.8-9.6H171.5c-5.7 0-10.6 4-11.8 9.6L147.2 83c-20.1 6.9-39 17.4-55.5 30.9L34.5 94.7c-5.6-1.9-11.9 .4-14.9 5.5l-46 79.7c-3 5.1-1.8 11.6 2.8 15.2l48.6 37.9c-3.8 20.9-3.8 42.5 0 63.4L-23.6 353.6c-4.6 3.6-5.8 10.1-2.8 15.2l46 79.7c3 5.1 9.3 7.4 14.9 5.5l57.2-19.9c16.5 13.5 35.4 24 55.5 30.9l12.5 59.2c1.2 5.6 6.1 9.6 11.8 9.6H340.5c5.7 0 10.6-4 11.8-9.6l12.5-59.2c20.1-6.9 39-17.4 55.5-30.9l57.2 19.9c5.6 1.9 11.9-.4 14.9-5.5l46-79.7c3-5.1 1.8-11.6-2.8-15.2L487.4 315.7zM256 336c-44.2 0-80-35.8-80-80s35.8-80 80-80s80 35.8 80 80s-35.8 80-80 80z"/></svg>',
        ];
    }
@endphp
